...
searchInput.addEventListener("input", (event) => {
  ...
  cards.forEach(card => {
    const cardText = card.querySelector('.text-content').textContent.toLowerCase(); // Get the text content of each card

    // Check if the card text matches the search term
